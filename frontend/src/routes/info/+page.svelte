<script lang="ts">
	...
	let matchPoints = $derived.by(() => [
		...
		{ label: language.text('Sluttspill: rett FT-utfall (S/U/B)', 'Sluttspel: rett FT-utfall (S/U/B)', 'Knockout: correct FT outcome (W/D/L)'), value: '+5', detail: language.text('hvem vant / uavgjort etter 90 min', 'kven vann / uavgjort etter 90 min', 'who won / draw after 90 min') },
		...
		{ label: language.text('Sluttspill: rett ET-utfall (S/U/B)', 'Sluttspel: rett ET-utfall (S/U/B)', 'Knockout: correct ET outcome (W/D/L)'), value: '+5', detail: language.text('kun hvis kamp gikk til ekstraomganger og du tippa uavgjort etter 90 min', 'berre viss kampen gjekk til ekstraomgangar og du tippa uavgjort etter 90 min', 'only if match went to extra time and you predicted a draw at FT') },
		...
		{ label: language.text('Sluttspill: rett lag videre', 'Sluttspel: rett lag vidare', 'Knockout: correct team to advance'), value: '+10', detail: language.text('laget som faktisk gikk videre (inkl. etter straffespark)', 'laget som faktisk gjekk vidare (inkl. etter straffespark)', 'the team that actually advanced (including after penalties)') },
